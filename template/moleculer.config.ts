 ...
 *  }
 */
import Moleculer, { BrokerOptions } from 'moleculer';
...
const brokerConfig: BrokerOptions = {
  ...
  transporter: Config.TRANSPORTER,{{#if needTransporter}} //"{{transporter}}"{{/if}}

  // Define a cacher.
  // More info: https://moleculer.services/docs/0.14/caching.html
  cacher: Config.CACHER,{{#if needCacher}} //"{{cacher}}"{{/if}}
  ...
  errorHandler(err, info: any) {
    ...
    (info.service.logger || console).error(
      'errorHandler:',
      msg,
      '\n\n--- CONTEXT ---\n',
      context,
  ...
  // created: function (_broker) {
  //   // console.info('Broker created', broker.instanceID);
  // },

  // Called after broker started.
  // started: async function (_broker) {
  //   // console.info('Broker started', broker.instanceID);
  // },

  // Called after broker stopped.
  // stopped: async function (_broker) {
  //   // console.info('Broker stopped', broker.instanceID);
  // }
};
